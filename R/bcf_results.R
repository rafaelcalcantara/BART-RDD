...
res.mat.1.4[2,] <- res.mat.2.4[2,] <- c("BCF","DGP 1","","","","","")
res.mat.1.4[4,] <- res.mat.2.4[4,] <- c("BCF","DGP 2","","","","","")
res.mat.1.4[6,] <- res.mat.2.4[6,] <- c("BCF","DGP 3","","","","","")
...
res.mat.1.6[2,] <- res.mat.2.6[2,] <- c("BCF","DGP 1","","","","","")
res.mat.1.6[4,] <- res.mat.2.6[4,] <- c("BCF","DGP 2","","","","","")
res.mat.1.6[6,] <- res.mat.2.6[6,] <- c("BCF","DGP 3","","","","","")
...
res.mat.1.10[2,] <- c("BCF","DGP 1","","","","","")
res.mat.2.10[2,] <- c("BCF","DGP 4","","","","","")
res.mat.1.10[4,] <- c("BCF","DGP 2","","","","","")
res.mat.2.10[4,] <- c("BCF","DGP 5","","","","","")
res.mat.1.10[6,] <- c("BCF","DGP 3","","","","","")
res.mat.2.10[6,] <- c("BCF","DGP 6","","","","","")
...
###
rm(data,results,no_cores,readFiles,readFiles2,ate1,ate2,ate3,ate4,ate5,ate6,ate7)
