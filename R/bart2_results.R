...
res.mat.1.4[2,] <- res.mat.2.4[2,] <- c("XBART2","DGP 1","","","","","")
res.mat.1.4[4,] <- res.mat.2.4[4,] <- c("XBART2","DGP 2","","","","","")
res.mat.1.4[6,] <- res.mat.2.4[6,] <- c("XBART2","DGP 3","","","","","")
...
res.mat.1.6[2,] <- res.mat.2.6[2,] <- c("XBART2","DGP 1","","","","","")
res.mat.1.6[4,] <- res.mat.2.6[4,] <- c("XBART2","DGP 2","","","","","")
res.mat.1.6[6,] <- res.mat.2.6[6,] <- c("XBART2","DGP 3","","","","","")
...
res.mat.1.10[2,] <- c("XBART2","DGP 1","","","","","")
res.mat.2.10[2,] <- c("XBART2","DGP 4","","","","","")
res.mat.1.10[4,] <- c("XBART2","DGP 2","","","","","")
res.mat.2.10[4,] <- c("XBART2","DGP 5","","","","","")
res.mat.1.10[6,] <- c("XBART2","DGP 3","","","","","")
res.mat.2.10[6,] <- c("XBART2","DGP 6","","","","","")
...
save.image("Tables/xbart2_results.RData")
####
stopImplicitCluster()
####
