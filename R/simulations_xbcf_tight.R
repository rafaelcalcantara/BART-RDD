    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            saveRDS(fit,paste0("Results/xbcf_tight_1a_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            saveRDS(fit,paste0("Results/xbcf_tight_1b_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,NULL,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_2a_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,data[[i]]$w,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_2b_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,NULL,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_3a_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,data[[i]]$w,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_3b_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,NULL,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_4a_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,data[[i]]$w,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_4b_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,NULL,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_5a_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,data[[i]]$w,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_5b_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,NULL,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_6a_",p,"_",i,".rds"))
        }
}
    ...
    foreach(i=1:s,.multicombine=T,.export=c("p","c","Omin","Opct","m","n","num_sweeps","burnin","Nmin","p_categorical")) %dopar%
        {
            ...
            fit <- fit.xbcf(data[[i]]$y,data[[i]]$w,data[[i]]$x)
            saveRDS(fit,paste0("Results/xbcf_tight_6b_",p,"_",i,".rds"))
        }
}
####
c             <- 0
