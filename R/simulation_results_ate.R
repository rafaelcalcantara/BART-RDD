...
xyplot(RMSE~Method|factor(Nu,labels=paste("Nu=",c(0.25,2),sep=""))+factor(Kappa,labels=paste("Kappa=",c(0.25,2),sep="")),data=subset(plot.rmse,Model %in% 3:4),groups=factor(Xi,labels=paste("Xi=",c(0.25,2),sep="")),auto.key=list(column=2,cex=0.75),scales=list(cex=0.5))
dev.off()
png("Figures/rmse2.png")
xyplot(RMSE~Method|factor(Nu,labels=paste("Nu=",c(0.25,2),sep=""))+factor(Kappa,labels=paste("Kappa=",c(0.25,2),sep="")),data=subset(plot.rmse,Model %in% 5:6),groups=factor(Xi,labels=paste("Xi=",c(0.25,2),sep="")),auto.key=list(column=2,cex=0.75),scales=list(cex=0.5))
dev.off()
### Cov x Length
p <- merge(plot.cov,plot.length)
p$Length <- log(p$Length)
png("Figures/coverage1.png")
xyplot(Coverage~Length|factor(Nu,labels=paste("Nu=",c(0.25,2),sep=""))+factor(Kappa,labels=paste("Kappa=",c(0.25,2),sep="")),data=subset(p,Model %in% 3:4),groups=factor(Method),auto.key=list(column=7,cex=0.5),scales=list(cex=0.5))
dev.off()
png("Figures/coverage2.png")
xyplot(Coverage~Length|factor(Nu,labels=paste("Nu=",c(0.25,2),sep=""))+factor(Kappa,labels=paste("Kappa=",c(0.25,2),sep="")),data=subset(p,Model %in% 5:6),groups=factor(Method),auto.key=list(column=7,cex=0.5),scales=list(cex=0.5))
dev.off()
### Interval inflation
...
xyplot(`Corrected Interval Length`~Method|factor(Nu,labels=paste("Nu=",c(0.25,2),sep=""))+factor(Kappa,labels=paste("Kappa=",c(0.25,2),sep="")),data=subset(d,Model %in% 3:4),groups=factor(Xi,labels=paste("Xi=",c(0.25,2),sep="")),auto.key=list(column=2,cex=0.75),scales=list(cex=0.5))
dev.off()
png("Figures/length2.png")
xyplot(`Corrected Interval Length`~Method|factor(Nu,labels=paste("Nu=",c(0.25,2),sep=""))+factor(Kappa,labels=paste("Kappa=",c(0.25,2),sep="")),data=subset(d,Model %in% 5:6),groups=factor(Xi,labels=paste("Xi=",c(0.25,2),sep="")),auto.key=list(column=2,cex=0.75),scales=list(cex=0.5))
dev.off()
