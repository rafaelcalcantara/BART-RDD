...
boxplot(`Corrected Interval`~Method,data=d)
d$Method <- as.factor(d$Method)
xyplot(`Corrected Interval`~Method|factor(Nu,labels=paste("Nu=",c(0.25,2),sep=""))+factor(Kappa,labels=paste("Kappa=",c(0.25,2),sep="")),data=d,groups=factor(Xi,labels=paste("Xi=",c(0.25,2),sep="")),auto.key=T,scales=list(cex=0.5))
